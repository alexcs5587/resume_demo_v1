...
function Resume() {
    ...
    const langItem = TechSkillsData.langList.map(item => <span key={item} className="tech-btn rounded-pill">{item}</span>)
    const toolItem = TechSkillsData.toolList.map(item => <span key={item} className="tech-btn rounded-pill">{item}</span>)
    const databaseItem = TechSkillsData.databaseList.map(item => <span key={item} className="tech-btn rounded-pill">{item}</span>)
